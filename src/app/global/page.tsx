...
export default function GlobalNewsPage() {
    const [activeTab, setActiveTab] = useState<'us' | 'jp'>('us');
        ...
        <main className="max-w-4xl mx-auto py-16 px-6 sm:px-8">
            <header className="text-center mb-12 animate-fade-in">
                ...
                <p className="text-lg text-text-main font-semibold mb-1.5 px-4">
                    {activeTab === 'us' ? '미국의 정치, 경제, 사회 전반의 핵심 이슈' : '일본의 정치, 경제, 사회 트렌드 현지 소식'}
                </p>
            ...
            <div className="flex border-b border-card-border mb-10 overflow-x-auto no-scrollbar">
                {[
                    ...
                    <button
                        ...
                        className={`flex-1 sm:flex-none px-12 py-4 text-[1.1rem] font-bold transition-all border-b-2 whitespace-nowrap ${
                            activeTab === tab.id
